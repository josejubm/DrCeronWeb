    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-6">
                <a class="site-title"><span>Dr. </span>Ceron</a>
                <p>Hospital Clinico Veterinario.</p>
                <p>Especialista en Mascotas.</p>
            </div>
            <div class="col-lg-offset-2 col-md-5 col-sm-4 col-md-offset-2 col-sm-offset-4 col-xs-6 ">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <div class="text-right">
                        <p>&copy; 2022-Clinica Veterinaria Dr. Ceron</p>
